        ...
        return (
          <div className="border-t border-rosePrimary/10 pt-4 space-y-4">
            <div className="flex justify-between items-center">
              <h4 className="font-heading font-bold text-sm text-wineDeep">Memory Tree Nodes ({memories.length} / {maxMem})</h4>
              <span className="text-[9px] text-slate-450 font-bold uppercase tracking-wider">Max {maxMem} Memories</span>
            </div>
            ...
            {memories.length >= maxMem ? (
              ...
              <div className="bg-rose-50/20 border border-rosePrimary/10 rounded-2xl p-4 space-y-3.5 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-[9px] font-bold text-slate-500 uppercase block mb-1">Memory Photo / Video (Upload/URL)</label>
                    <div className="flex flex-col gap-2">
                      <input
                        type="url"
                        value={newMemImage}
