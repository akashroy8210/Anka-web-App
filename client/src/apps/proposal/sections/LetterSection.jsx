        ...
        {activeLetter && (
          ...
          >
            ...
            <motion.div
              ...
              className="bg-[#FCF9F2] rounded-[36px] p-8 md:p-10 max-w-md w-full shadow-[0_25px_60px_-15px_rgba(0,0,0,0.6)] relative text-left border border-[#EDE5D6] text-slate-800"
              style={{
            ...
            >
              ...
              <button
                onClick={() => setActiveLetter(null)}
                className="absolute top-5 right-5 p-1 rounded-full bg-slate-200/50 hover:bg-slate-200 text-slate-500 hover:text-slate-800 transition-colors cursor-pointer"
              >
                <X className="w-4.5 h-4.5" />
              </button>

              {/* Romantic Header */}
              <div className="flex items-center gap-2 border-b border-slate-200/80 pb-3 mb-5 select-none">
              ...
              <p className="font-handwritten text-xl sm:text-2xl leading-relaxed text-slate-700 whitespace-pre-line min-h-48 max-h-[48vh] overflow-y-auto pr-2 select-text selection:bg-rose-250">
                {activeLetter.content}
              </p>

              {/* Hand-written closing signature */}
              <div className="mt-6 pt-4 border-t border-slate-200/60 flex justify-between items-center select-none">
